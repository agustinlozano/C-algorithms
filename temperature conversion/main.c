...
int main (void) {
    ...
    printf("Su decision es: ");
    scanf("%d", &decisionDeUsuario);

    if (decisionDeUsuario == 1) {
        printf("Ingrese por favor el valor en grados celsius: ");
        scanf("%f", &celsius);
        ...
        printf("Ingrse por favor el valor en grados fahrenheit: ");
        scanf("%f", &fahrenheit);
